#!/usr/bin/env python3
"""
Improved training script for signature detection with better parameters for small datasets.
"""
...
def train_improved():
    ...
    # Improved training parameters for small datasets
    training_params = {
        ...
        'name': 'signature_detector_improved',
        'save': True,
    ...
    try:
        ...
        print(f"📁 Best model saved to: {models_dir}/signature_detector_improved/weights/best.pt")
        print(f"📁 Last model saved to: {models_dir}/signature_detector_improved/weights/last.pt")
